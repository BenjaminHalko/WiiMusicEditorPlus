...
echo "creating app"
/usr/local/bin/platypus -y -B -i 'Icon/icon.icns' -a 'WiiMusicEditorPlus' -o 'None' -p '/bin/sh'   '/Users/benjamin/Desktop/WiiMusicEditorPlus/dist/WiiMusicEditorPlus/WiiMusicEditorPlus'
echo "copying helper"
