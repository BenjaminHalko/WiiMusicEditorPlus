...
echo "creating app"
/usr/local/bin/platypus -y -R -B -i 'Icon/icon.icns'  -a 'WiiMusicEditorPlus'  -o 'None'  -p '/bin/sh'  -f 'dist/WiiMusicEditorPlus/WiiMusicEditorPlus' -f 'crossplatformhelpers/Mac/Helper' macscript.sh dist/WiiMusicEditorPlus/WiiMusicEditorPlus.app
echo "creating .zip"
