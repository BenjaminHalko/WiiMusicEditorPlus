...
"}\n"
"\n"
"QDockWidget::close-butt"
                        "on:pressed, QDockWidget::float-button:pressed\n"
"{\n"
...
"    background-color: QLinearGradient(x1:0, y1:0, x2:0, y2:1, stop:0 #"
                        "161616, stop: 0.5 #151515, stop: 0.6 #212121, stop:1 #343434);\n"
"    color: white;\n"
"    padding-left: 4px;\n"
"    margin-left: 10px;\n"
"    margin-right: 5px;\n"
...
"{\n"
" margin-le"
                        "ft: 0px; /* the last selected tab has nothing to overlap with on the right */\n"
"\n"
"\n"
...
"}")
        ...
        self.NewUpdate_Line.setFrameShape(QFrame.HLine)
        ...
        self.NewUpdate_Buttons = QHBoxLayout()
        ...
        self.Updating_Spacer = QSpacerItem(20, 185, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.NoUpdate_Title = QLabel(self.NoUpdate)
        self.NoUpdate_Title.setObjectName(u"NoUpdate_Title")
        self.NoUpdate_Title.setFont(font)

        self.verticalLayout_5.addWidget(self.NoUpdate_Title)

        self.NoUpdate_Line = QFrame(self.NoUpdate)
        self.NoUpdate_Line.setObjectName(u"NoUpdate_Line")
        self.NoUpdate_Line.setFrameShape(QFrame.HLine)
        self.NoUpdate_Line.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_5.addWidget(self.NoUpdate_Line)

        self.NoUpdate_Spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.verticalLayout_5.addItem(self.NoUpdate_Spacer)

        self.NoUpdate_Button = QPushButton(self.NoUpdate)
        self.NoUpdate_Button.setObjectName(u"NoUpdate_Button")
        self.NoUpdate_Button.setMinimumSize(QSize(0, 20))

        self.verticalLayout_5.addWidget(self.NoUpdate_Button)
