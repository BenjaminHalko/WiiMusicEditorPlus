...
################################################################################
## Form generated from reading UI file 'revert_changes.ui'
##
...
class Ui_Revert(object):
    def setupUi(self, Revert):
        if not Revert.objectName():
            Revert.setObjectName(u"Revert")
        Revert.setWindowModality(Qt.ApplicationModal)
        Revert.resize(256, 208)
        Revert.setStyleSheet(u"QToolTip\n"
"{\n"
...
"    border: 1px solid #444;\n"
"}")
        self.verticalLayout = QVBoxLayout(Revert)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.Title = QLabel(Revert)
        ...
        self.Checkboxes1 = QHBoxLayout()
        self.Checkboxes1.setObjectName(u"Checkboxes1")
        self.Songs = QCheckBox(Revert)
        self.Songs.setObjectName(u"Songs")

        self.Checkboxes1.addWidget(self.Songs)

        self.Styles = QCheckBox(Revert)
        ...
        self.Checkboxes2 = QHBoxLayout()
        self.Checkboxes2.setObjectName(u"Checkboxes2")
        self.Text = QCheckBox(Revert)
        ...
        self.SelectButton = QPushButton(Revert)
        self.SelectButton.setObjectName(u"SelectButton")

        self.Buttons.addWidget(self.SelectButton)

        self.DeselectButton = QPushButton(Revert)
        ...
        self.PatchButton = QPushButton(Revert)
        self.PatchButton.setObjectName(u"PatchButton")
        self.PatchButton.setMinimumSize(QSize(0, 45))
        font1 = QFont()
        font1.setFamilies([u"Continuum Medium"])
        font1.setPointSize(20)
        self.PatchButton.setFont(font1)
        ...
        QMetaObject.connectSlotsByName(Revert)
    # setupUi

    def retranslateUi(self, Revert):
        Revert.setWindowTitle(QCoreApplication.translate("Revert", u"Revert Changes", None))
        self.Title.setText(QCoreApplication.translate("Revert", u"Revert Changes", None))
