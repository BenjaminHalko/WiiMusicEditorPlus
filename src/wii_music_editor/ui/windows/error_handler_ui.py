...
"}")
        ...
        self.ErrorTitle.setText(u"Error")
        ...
        self.ErrorSpacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.ErrorSpacer_GC = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
