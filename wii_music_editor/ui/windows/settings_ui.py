...
"}")
        ...
        self.General_Spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
...
"}")
        ...
        self.Tab_Dolphin_Spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
