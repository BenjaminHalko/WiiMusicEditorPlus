...
class Ui_Confirm(object):
    def setupUi(self, Confirm):
        ...
        Confirm.setStyleSheet(u"QToolTip\n"
"{\n"
...
"}")
        ...
        self.text = QLabel(Confirm)
        self.text.setObjectName(u"text")
        self.text.setText(u"Words")
        ...
        self.noButton = QPushButton(Confirm)
    ...
    def retranslateUi(self, Confirm):
        Confirm.setWindowTitle(QCoreApplication.translate("Confirm", u"Wii Music Editor Plus", None))
        self.noButton.setText(QCoreApplication.translate("Confirm", u"Cancel", None))
        self.yesButton.setText(QCoreApplication.translate("Confirm", u"Ok", None))
    # retranslateUi
