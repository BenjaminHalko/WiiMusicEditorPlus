...
"}")
        ...
        self.WarningSymbol = QLabel(Warning)
        self.WarningSymbol.setObjectName(u"WarningSymbol")
        self.WarningSymbol.setMaximumSize(QSize(32, 16777215))
        self.WarningSymbol.setText(u"<html><head/><body><p><img src=\":/images/images/warning.png\"/></p></body></html>")

        self.Title.addWidget(self.WarningSymbol)

        self.WarningTitle = QLabel(Warning)
        self.WarningTitle.setObjectName(u"WarningTitle")
        font = QFont()
        ...
        self.WarningText = QLabel(Warning)
        self.WarningText.setObjectName(u"WarningText")
        self.WarningText.setText(u"Warning text")
