...
################################################################################
## Form generated from reading UI file 'import_changes.ui'
##
...
class Ui_Import(object):
    def setupUi(self, Import):
        ...
        Import.setStyleSheet(u"QToolTip\n"
"{\n"
...
"    border: 1px solid #444;\n"
"}")
        self.verticalLayout = QVBoxLayout(Import)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.Label = QLabel(Import)
        self.Label.setObjectName(u"Label")
        self.Label.setText(u"Import Change 0 out of 0")
        ...
        self.Progress = QProgressBar(Import)
    ...
    def retranslateUi(self, Import):
        Import.setWindowTitle(QCoreApplication.translate("Import", u"Import Changes", None))
    # retranslateUi
