# Form implementation generated from reading ui file 'pack_rom.ui'
#
...
class Ui_Packrom(object):
    def setupUi(self, Packrom):
        ...
        Packrom.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
...
"}")
        ...
        self.Title = QtWidgets.QLabel(parent=Packrom)
        ...
        self.TitleLine = QtWidgets.QFrame(parent=Packrom)
        ...
        self.RomTypeLabel = QtWidgets.QLabel(parent=Packrom)
        self.RomTypeLabel.setObjectName("RomTypeLabel")
        self.RomTypeLayout.addWidget(self.RomTypeLabel)
        self.RomTypeWbfs = QtWidgets.QRadioButton(parent=Packrom)
        self.RomTypeWbfs.setText(".wbfs")
        self.RomTypeWbfs.setChecked(True)
        self.RomTypeWbfs.setObjectName("RomTypeWbfs")
        self.RomTypeLayout.addWidget(self.RomTypeWbfs)
        self.RomTypeIso = QtWidgets.QRadioButton(parent=Packrom)
        self.RomTypeIso.setText(".iso")
        ...
        self.PatchMainDolCheckbox = QtWidgets.QCheckBox(parent=Packrom)
        ...
        self.CreateRom = QtWidgets.QPushButton(parent=Packrom)
        self.CreateRom.setMinimumSize(QtCore.QSize(0, 45))
        font = QtGui.QFont()
        font.setFamily("Continuum Medium")
        font.setPointSize(20)
        self.CreateRom.setFont(font)
