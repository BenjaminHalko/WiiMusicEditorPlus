# Form implementation generated from reading ui file 'import_changes.ui'
#
...
class Ui_Import(object):
    def setupUi(self, Import):
        ...
        Import.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
...
"}")
        ...
        self.Label = QtWidgets.QLabel(parent=Import)
        self.Label.setText("Import Change 0 out of 0")
        self.Label.setObjectName("Label")
        self.verticalLayout.addWidget(self.Label)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout.addItem(spacerItem)
        self.Progress = QtWidgets.QProgressBar(parent=Import)
