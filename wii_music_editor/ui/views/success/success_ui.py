...
"}")
        ...
        self.CompleteSymbol = QtWidgets.QLabel(parent=Success)
        ...
        self.CompleteTitle = QtWidgets.QLabel(parent=Success)
        font = QtGui.QFont()
        ...
        self.CompleteClose = QtWidgets.QPushButton(parent=Success)
